...
if __name__ == "__main__":
	...
	try:
		if args.emulation:
			...
			mapper.main.main(outputFormat=args.format, interface=args.interface, localHost=args.local_host, localPort=args.local_port, remoteHost=args.remote_host, remotePort=args.remote_port, noSsl=args.no_ssl)
	except:

...
def main(outputFormat, interface, promptTerminator, gagPrompts, find_format, localHost, localPort, remoteHost, remotePort, noSsl):
	...
	mapperThread = Mapper(client=clientConnection, server=serverConnection, outputFormat=outputFormat, interface=interface, promptTerminator=promptTerminator, gagPrompts=gagPrompts, find_format=find_format)
